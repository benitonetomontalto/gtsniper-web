...
├── data/                # Banco de dados
├── run_gtsniper.py    # Servidor principal
...
O GT Sniper usa sistema de autenticação baseado em tokens de acesso.
...
GT Sniper © 2025 - Sistema de Trading Profissional com IA
