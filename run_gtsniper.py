"""
GT Sniper - Standalone Executable Entry Point
...
def open_browser():
    ...
    time.sleep(2)
    logger.info("Abrindo GT Sniper no navegador...")
    webbrowser.open('http://127.0.0.1:8000')

def main():
    """Função principal"""
    logger.info("=" * 60)
    logger.info("🚀 GT SNIPER - AI TRADING SYSTEM")
    logger.info("=" * 60)
    ...
    logger.info("")
    logger.info("✅ GT Sniper iniciado com sucesso!")
