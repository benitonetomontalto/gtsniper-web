# GT SNIPER - GUIA DE DEPLOY ONLINE

## Como Colocar Online GRATUITAMENTE

Este guia vai te ensinar a colocar o GT Sniper online usando **Render.com** (100% grátis).
...
2. Nome do repositório: **gtsniper-web**
...
4. Escolha esta pasta: `C:\Users\benit\Desktop\GTSniper_DEPLOY`
...
```bash
cd C:\Users\benit\Desktop\GTSniper_DEPLOY
...
git commit -m "Deploy GT Sniper"

# Conectar com GitHub
git remote add origin https://github.com/SEU_USUARIO/gtsniper-web.git
...
3. Conecte seu repositório: **gtsniper-web**
4. Clique em "Connect"
...
Start Command: python run_gtsniper.py
```
...
```
✅ GT Sniper iniciado com sucesso!
...
```
https://gtsniper-web-xxxx.onrender.com
```
...
Se quiser usar seu próprio domínio (ex: gtsniper.com.br):
...
3. Ajuste `run_gtsniper.py` se necessário
...
3. Teste localmente antes: `python run_gtsniper.py`
...
```
GTSniper_DEPLOY/
├── run_gtsniper.py       # Arquivo principal
...
Seguindo este guia, você terá o GT Sniper rodando online **gratuitamente** em menos de 15 minutos!
